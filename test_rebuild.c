 ...
 *  -------------------------------------------------------------------------
 *
 * Created: Sat Aug 24 20:18:30 2024
 */

#define S_FUNCTION_LEVEL               2
#define S_FUNCTION_NAME                test_rebuild
...
extern void test_rebuild_Outputs_wrapper(const real_T *u0,
  real_T *y0);
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
  ...
  test_rebuild_Outputs_wrapper(u0, y0);
}
