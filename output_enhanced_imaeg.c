 ...
 *  -------------------------------------------------------------------------
 *
 * Created: Sat Aug 24 16:28:44 2024
 */

#define S_FUNCTION_LEVEL               2
#define S_FUNCTION_NAME                output_enhanced_imaeg
...
extern void output_enhanced_imaeg_Outputs_wrapper(const real_T *u0,
  real_T *y0);
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
  ...
  output_enhanced_imaeg_Outputs_wrapper(u0, y0);
}
